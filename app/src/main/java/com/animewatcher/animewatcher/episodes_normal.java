 ...
 * Use the {@link episodes_normal#newInstance} factory method to
 * create an instance of this fragment.
 */
public class episodes_normal extends Fragment {
     ...
     * @return A new instance of fragment episodes_normal.
     */
    // TODO: Rename and change types and number of parameters
    public static episodes_normal newInstance(String param1, String param2) {
        episodes_normal fragment = new episodes_normal();
    ...
    Boolean special_only = false;

    TextView lbl_no_episodes;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View v = inflater.inflate(R.layout.fragment_episodes_normal, container, false);
            ...
            public void onResponse(String response) {
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++)
                    {
                        ...
                        if(!episode.getBoolean("mIsSpecial") || special_only){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    special_only = objres.getBoolean("Status");
